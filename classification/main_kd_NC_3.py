...
def train(epoch,a1=1,a2=1,a4=1,a5=1):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        outputs_t = (a1*(outputs_t05+outputs_t1)+a2*(outputs_t15+outputs_t2)+a4*(outputs_t4+outputs_t45)+a5*outputs_t5)/(a1*2+a2*2+a4*2+a5)
...
def test_all(epoch):
    ...
    torch.save(net_s.state_dict(), "checkpoint_NC/rram/cifar10/vgg16_nonid/"+'/ckpt_'+args.dataset+'_nonid_T:0.05_0.1_0.15_0.2_0.4_0.45_0.5_bh2_S:'+str(args.noise)+'.pth')
