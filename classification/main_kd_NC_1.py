...
def train(epoch,a1=1,a2=1,a4=1,a5=1):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        loss = distillation(outputs, targets, outputs_t, temp=5.0, alpha=0.3)
...
def test_all(epoch):
    ...
    torch.save(net_s.state_dict(), "checkpoint_NC/rram/cifar10/vgg16_nonid/"+'/ckpt_'+args.dataset+'_nonid_T:0.1_0.2_0.4_0.5_bh2_alpha=0.3_S:'+str(args.noise)+'.pth')
