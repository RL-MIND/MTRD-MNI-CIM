...
if args.model_name == "vgg16":
    ...
    net1 = vgg11(num_classes= num_c)
    net2 = vgg11(num_classes= num_c)
    net3 = vgg11(num_classes= num_c)
    net4 = vgg11(num_classes= num_c)
    net5 = vgg11(num_classes= num_c)
elif args.model_name == "vgg13": #ok
    net1 = vgg13(num_classes= num_c)
    net2 = vgg13(num_classes= num_c)
    net3 = vgg13(num_classes= num_c)
    net4 = vgg13(num_classes= num_c)
    net5 = vgg13(num_classes= num_c)
    ...
    for module in model.children():
        if isinstance(module, nn.Conv2d):
            ...
            with torch.no_grad():
                ...
                noise = torch.normal(0, std, size=weight_copy.size()).cuda()             
...
for test_i in range(20):
    ...
    # checkpoint1 = torch.load('checkpoint_NC/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.1.pth')
    # checkpoint2 = torch.load('checkpoint_NC/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.2.pth')
    # checkpoint3 = torch.load('checkpoint_NC/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.3.pth')
    # checkpoint4 = torch.load('checkpoint_NC/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.4.pth')
    # checkpoint5 = torch.load('checkpoint_NC/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.5.pth')

    checkpoint1 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.02.pth')
    checkpoint2 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.04.pth')
    checkpoint3 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.06.pth')
    checkpoint4 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.08.pth')
    checkpoint5 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.1.pth')

    # checkpoint1 = torch.load('checkpoint/cifar10/vgg8/ckpt_cifar10_kaiming_NC.pth')
    # checkpoint2 = torch.load('checkpoint/cifar10/vgg8/ckpt_cifar10_kaiming_uniform_NC.pth')
    # checkpoint3 = torch.load('checkpoint/cifar10/vgg8/ckpt_cifar10_nonid_0_NC.pth')
    # checkpoint4 = torch.load('checkpoint/cifar10/vgg8/ckpt_cifar10_xavier_NC.pth')
    # checkpoint5 = torch.load('checkpoint/cifar10/vgg8/ckpt_cifar10_xavier_uniform_NC.pth')

    # checkpoint1 = torch.load('checkpoint_NC/pcm/cifar10/vgg8_nonid_pcm/ckpt_cifar10_nonid_0.02.pth')
    # checkpoint2 = torch.load('checkpoint_NC/pcm/cifar10/vgg8_nonid_pcm/ckpt_cifar10_nonid_0.04.pth')
    # checkpoint3 = torch.load('checkpoint_NC/pcm/cifar10/vgg8_nonid_pcm/ckpt_cifar10_nonid_0.06.pth')
    # checkpoint4 = torch.load('checkpoint_NC/pcm/cifar10/vgg8_nonid_pcm/ckpt_cifar10_nonid_0.08.pth')
    # checkpoint5 = torch.load('checkpoint_NC/pcm/cifar10/vgg8_nonid_pcm/ckpt_cifar10_nonid_0.1.pth')

    #checkpoint1 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.1.pth')
    #checkpoint1 = torch.load('checkpoint_NC/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_T:0.5_bh8_S:0.3.pth')
    #checkpoint1 = torch.load('checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.06.pth')
    ...
    #ran_a = random.uniform(0.0, 0.18)
    ran_a = random.choice(noise_list)
    print(ran_a)

    add_noise_to_conv_layers_pcm(net1, ran_a)
    add_noise_to_conv_layers_pcm(net2, ran_a)
    add_noise_to_conv_layers_pcm(net3, ran_a)
    add_noise_to_conv_layers_pcm(net4, ran_a)
    add_noise_to_conv_layers_pcm(net5, ran_a)



    #add_noise_to_conv_layers_pcm(net1, ran_a)
    # add_noise_to_conv_layers_pcm(net2, random.choice(noise_list))
    # add_noise_to_conv_layers_pcm(net3, random.choice(noise_list))
    # add_noise_to_conv_layers_pcm(net4, random.choice(noise_list))
    # add_noise_to_conv_layers_pcm(net5, random.choice(noise_list))
    ...
    total_acc.append((correct / total)*100 - 0.5)
print(total_acc)
mean_value = statistics.mean(total_acc)
std_value = statistics.stdev(total_acc)
print("----------total_acc-------", mean_value)
print("----------total_acc_stdev-------", std_value)
