...
def train(epoch,a1=1,a2=1,a4=1,a5=1):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        outputs_t1 = net_t1(inputs, 0.02).detach()
        outputs_t2 = net_t2(inputs, 0.04).detach()
        #outputs_t3 = net_t2(inputs, lamda=0.3).detach()
        outputs_t4 = net_t4(inputs, 0.08).detach()
        outputs_t5 = net_t5(inputs, 0.1).detach()
...
def test_all(epoch):
    ...
    torch.save(net_s.state_dict(), "checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/"+'/ckpt_'+args.dataset+'_nonid_T:0.02_0.04_0.08_0.1_bh2_S:'+str(args.noise)+'.pth')
