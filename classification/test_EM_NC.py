...
parser.add_argument('--precheckpoint_root', default='checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.06.pth', help='Load precheckpoint', type=str)
...
for item in noise_list:
    ...
    for test_i in range(5):
        ...
        checkpoint1 = torch.load('checkpoint_NC2/rram/cifar10/vgg8_nonid/ckpt_cifar10_nonid_0.1.pth')
        checkpoint2 = torch.load('checkpoint_NC2/rram/cifar10/vgg8_nonid/ckpt_cifar10_nonid_0.2.pth')
        checkpoint3 = torch.load('checkpoint_NC2/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.3.pth')
        checkpoint4 = torch.load('checkpoint_NC2/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.4.pth')
        checkpoint5 = torch.load('checkpoint_NC2/rram/cifar10/vgg16_nonid/ckpt_cifar10_nonid_0.5.pth')
        ...
        #checkpoint1 = torch.load('checkpoint/cifar10/VGG16/ckpt_cifar10.pth')
        ...
        #add_noise_to_conv_layers_pcm(net1, item)
