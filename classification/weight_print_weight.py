...
parser.add_argument('--precheckpoint_root', default='classification/checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/ckpt_cifar10_nonid_0.16.pth', help='Load precheckpoint', type=str)
...
for key0 in weights0:
    ...
    if key0 == "conv8.weight":
        ...
        np.savetxt('weight_nonid_train/pcm/plo_0.16.csv', data, delimiter=',')
...
plt.savefig("weight_nonid_train/pcm/plo_0.16.png")
plt.show()
