...
def train(epoch,a1=1,a2=1,a4=1,a5=1):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        outputs_t = (a1*outputs_t1+a5*outputs_t5)/(a1+a5)
...
def test_all(epoch):
    ...
    torch.save(net_s.state_dict(), "checkpoint_NC/rram/cifar10/vgg16_nonid/"+'/ckpt_'+args.dataset+'_nonid_T:0.1_0.5_bh5_S:'+str(args.noise)+'.pth')
