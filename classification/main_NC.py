...
elif args.model_name == "vgg16_nonid_pcm": #ok
    net = vgg16_nonid_pcm(num_classes= num_c)
elif args.model_name == "vgg8": #ok
    net = vgg8(num_classes= num_c)
elif args.model_name == "vgg8_nonid": #ok
    net = vgg8_nonid(num_classes= num_c)
elif args.model_name == "vgg8_nonid_pcm": #ok
    net = vgg8_nonid_pcm(num_classes= num_c)
elif args.model_name == "vgg11": #ok
    net = vgg11(num_classes= num_c)
elif args.model_name == "vgg11_nonid": #ok
    net = vgg11_nonid(num_classes= num_c)
elif args.model_name == "vgg11_nonid_pcm": #ok
    net = vgg11_nonid_pcm(num_classes= num_c)
elif args.model_name == "vgg13": #ok
    net = vgg13(num_classes= num_c)
elif args.model_name == "vgg13_nonid": #ok
    net = vgg13_nonid(num_classes= num_c)
elif args.model_name == "vgg13_nonid_pcm": #ok
    net = vgg13_nonid_pcm(num_classes= num_c)
...
def test(epoch, sgm):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint_NC2/pcm/'+args.dataset+'/'+args.model_name):
            os.mkdir('checkpoint_NC2/pcm/'+args.dataset+'/'+args.model_name)
        torch.save(net.state_dict(), 'checkpoint_NC2/pcm/'+args.dataset+'/'+args.model_name+'/ckpt_'+args.dataset+'_nonid_'+str(args.noise)+'.pth')
        best_acc = acc
