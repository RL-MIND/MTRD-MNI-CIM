...
def train(epoch,a1=1,a2=1,a4=1,a5=1):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        out_a4 = outputs_t008
        #out_a5 = outputs_t01
        outputs_t = (a2*out_a2+a4*out_a4)/(a2+a4)
...
def test_all(epoch):
    ...
    torch.save(net_s.state_dict(), "checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/"+'/ckpt_'+args.dataset+'_nonid_T:0.04_0.08_bh6_S:'+str(args.noise)+'.pth')
