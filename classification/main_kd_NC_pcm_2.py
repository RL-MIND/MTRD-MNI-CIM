...
def train(epoch,a1=1,a2=1,a4=1,a5=1):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        out_a1 = outputs_t001 + outputs_t002
        out_a2 = outputs_t003 + outputs_t004 + outputs_t005
        out_a4 = outputs_t007 + outputs_t008
        out_a5 = outputs_t009 + outputs_t01
        outputs_t = (a1*out_a1+a2*out_a2+a4*out_a4+a5*out_a5)/(2*a1+3*a2+2*a4+2*a5)
...
def test_all(epoch):
    ...
    torch.save(net_s.state_dict(), "checkpoint_NC/pcm/cifar10/vgg16_nonid_pcm/"+'/ckpt_'+args.dataset+'_nonid_T:0.01_0.02_0.03_0.04_0.05_0.07_0.08_0.09_0.1_bh2_S:'+str(args.noise)+'.pth')
