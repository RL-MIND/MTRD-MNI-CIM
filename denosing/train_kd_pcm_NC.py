...
def main():
    ...
    for epoch in range(opt.epochs):
        ...
        for i, data in enumerate(loader_train, 0):
            ...
            outputs_t = (outputs_t1+outputs_t2+outputs_t4+outputs_t5)/4.0
        ...
        src_save = opt.outf + "/" + "DnCNN-S-" + str(int(opt.noiseL)) + '/pcm_net_T_0.02_0.04_0.08_0.1_S_'+str(opt.w_noiseL)+'.pth'
        # save model
